...
export default function ChatWidget() {
  ...
  return (
    <>
      <button
        onClick={() => setOpen((v) => !v)}
        className="fixed bottom-24 right-6 z-[60] w-12 h-12 flex items-center justify-center bg-ink text-paper border border-ink shadow-[0_2px_14px_rgba(0,0,0,0.12)] hover:scale-105 transition-transform"
      >
      ...
      {open && (
        <div className="fixed bottom-[152px] right-6 z-[60] w-80 h-[440px] bg-paper border border-neutral-200 shadow-[0_4px_24px_rgba(0,0,0,0.12)] flex flex-col overflow-hidden">
